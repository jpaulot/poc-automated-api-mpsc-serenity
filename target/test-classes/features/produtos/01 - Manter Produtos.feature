...
Funcionalidade: Manter Produtos
  ...
  Cenario: Cadastrar novo Produto
    Dado que envio uma requisição POST para o endpoint "/api/Products" com os dados
      | name        | Teste     |
  ...
  Cenario: Alterar Produto
    Dado que envio uma requisição PUT para o endpoint "/api/Products/1" com os dados
      | id          | 1                     |
